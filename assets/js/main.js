...
(function() {
    ...
    if (document.getElementById("iloveimg_settings__watermark__preview")) {
        ...
        jQuery(".iloveimg_settings__options__field-preview input[type='text'], .iloveimg_settings__options__field-preview input[type='number']").on("keyup change", function(element){
            changeTextStyle();
            resizeFont();
            changePosition();
        });
