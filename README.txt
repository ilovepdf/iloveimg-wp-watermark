...
* Updated development dependencies:
  ...
  - phpstan/extension-installer updated to version 1.4.3
...
Improved
* Update Libraries.
* Added text strings and updated translation files.
* Refactoring.

Fixed
* Incorrect closing HTML tag.
...
= 2.2.8 =
Improved
* library compatibility with PHP 7.4
...
Fixed
* Thumbnails and other intermediate sizes that came from a PDF file were watermarked.
