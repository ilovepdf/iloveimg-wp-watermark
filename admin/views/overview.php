...
<div class="iloveimg_settings__overview__statistics">
	...
	<div>
		<div class="iloveimg_settings__overview__statistics__column_right">
			<h4>Watermarked images <strong><?php echo (int) Ilove_Img_Wm_Resources::get_watermarked_files(); ?></strong> / Uploaded images <strong><?php echo (int) Ilove_Img_Wm_Resources::get_total_images(); ?></strong></h4>
