<div class="iloveimg_settings__overview__statistics">
	...
	<div>
		<div class="iloveimg_settings__overview__statistics__column_left">
			<?php $imagesSizes =  iLoveIMG_Watermark_Resources::getFilesSizes(); ?>
		...
		<div class="iloveimg_settings__overview__statistics__column_right">
			<h4>Original Compressed images <strong><?php echo iLoveIMG_Watermark_Resources::getFilesCompressed() ?></strong> / Uploaded images <strong><?php echo iLoveIMG_Watermark_Resources::getTotalImages() ?></strong></h4>
			<div class="iloveimg_percent  ">
