...
class Ilove_Img_Wm_I18n {
    ...
    public function set_script_translations() {
        if ( wp_script_is( 'iloveimg-watermark-main', 'enqueued' ) ) {
            wp_set_script_translations( 'iloveimg-watermark-main', 'iloveimg-watermark', plugin_dir_path( __DIR__ ) . 'languages' );
        }
    }
}
