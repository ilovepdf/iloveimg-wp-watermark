(function () {
    ...
    switch (adminpage) {
        ...
        case 'post-php':
            ...
            jQuery('<option>').val('iloveimg_bulk_action').text("Watermark").appendTo('select[name=action]');
            jQuery('<option>').val('iloveimg_bulk_action').text("Watermark").appendTo('select[name=action2]');
            ...
            const dialogComponent = `
                    <dialog id="iloveimg-watermark-restore-dialog" class="iloveimg-restore-dialog">
                        ...
                        <div class="iloveimg-btn-groups">
                            <button id="iloveimg-watermark-dialog-aceptted" class="button button-primary">Continue</button>
